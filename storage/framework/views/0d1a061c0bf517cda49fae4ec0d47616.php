    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::select('branch',$branches,null,array('class'=>'form-control select'))); ?>
...
<?php /**PATH C:\laragon\www\ucl-basic_erp\resources\views/trainer/create.blade.php ENDPATH**/ ?>